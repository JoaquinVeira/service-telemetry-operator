...
# infra.watch/service-telemetry-operator-bundle:$VERSION and infra.watch/service-telemetry-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/infrawatch-operators/service-telemetry-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.26.1/ansible-operator_$(OS)_$(ARCH) ;\
